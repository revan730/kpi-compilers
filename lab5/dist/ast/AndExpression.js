...
var AndExpression = (function () {
    function AndExpression(lhs, rhs) {
        var _this = this;
    ...
    AndExpression.prototype.evaluateType = function (s) {
    ...
    AndExpression.prototype.evaluateValue = function (s) {
        var lhsValue = this.lhs.evaluateValue(s);
        var rhsValue = this.rhs.evaluateValue(s);
        return lhsValue && rhsValue;
    };
    AndExpression.prototype.getIdentifiers = function () {
